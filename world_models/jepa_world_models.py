...
import sub_models.model.VAE.vae as contin_vae
...
class JEPABaseWorldModel(nn.Module):
    def __init__(self, 
                 in_width, action_dims,
                 patch_size, jepa_size, jepa_load_path:tuple,
                 vae_type, stoch_dim, final_feature_width, stem_channels, stem_repeat,
